...
import {User, Lock, SwitchButton, House, UserFilled,Message,Picture,Star,Notification,Setting,Reading,Suitcase,Ship,Flag} from '@element-plus/icons-vue'
      ...
      <aside class="admin-sidebar" :style="{ width: sideWidth + 'px'}">
        ...
        >
          ...
          <el-menu-item index="/back/article">
            ...
            <template #title>条例公告管理</template>
          </el-menu-item>
          ...
          <el-menu-item index="/back/borrow">
          ...
          <el-menu-item index="/back/entry">
            <el-icon><Flag /></el-icon>
            <template #title>活动参与管理</template>
          </el-menu-item>
