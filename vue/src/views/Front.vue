    ...
    <header class="header-nav">
      <div class="header-left-warp">
        ...
        <div class="header-navs">
          ...
          >
            <!--前台路由-->
            <el-menu-item index="/front/home">平台首页</el-menu-item>
            <el-menu-item index='/front/book'>图书大厅</el-menu-item>
            <el-menu-item index='/front/collect'>收藏图书</el-menu-item>
            <el-menu-item index='/front/myBorrow'>我的借阅</el-menu-item>
            <el-menu-item index='/front/activity'>活动中心</el-menu-item>
            <el-menu-item index='/front/myJoin'>我的活动</el-menu-item>
